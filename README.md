...
화면은 **지도 하나**입니다. 나머지는 전부 왼쪽 위 햄버거(☰) 안에 들어 있습니다.

### 지도

- **3계층** — 하늘 · 지상 · 지저를 지도 위 칩으로 전환. 끌어서 이동, 휠 · 두 손가락 확대,
  더블클릭 또는 ⤢ 로 전체 보기. 커서 위치의 게임 좌표가 왼쪽 아래에 표시됩니다.
...
그 밖에 **찾기**(⌕)로 보스 · 사당 · 조망대 · 지역을 한글/영문으로 검색해 지도로 이동할 수 있고,
